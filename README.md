...
```bash
uv add "bge-small-onnx @ git+https://github.com/listlessbird/bge-small-en-v1.5-onnx.git@v1.0.0"
```
...
```bash
uvx --from "git+https://github.com/listlessbird/bge-small-en-v1.5-onnx.git@v1.0.0" \
